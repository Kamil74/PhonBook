...
namespace PhonBook
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("2 Disply contact by number");
            ...
            while (true)
            {
                switch (userImput)
                {
                    case "1":
                        ...
                        phonBook.AddContact(newContact);
                    ...
                    case "2":
                        ...
                        phonBook.DisplayContact(numberToSearch);

                        break;
                    case "3":
                        phonBook.DisplayAllContacts();
                        break;
                    case "4":
                        Console.WriteLine("Insert search phrase");
                        var searchPhrase = Console.ReadLine();
                       phonBook.DisplayMatchingContacts(searchPhrase);
                        break;
                    case "x":
                        return;
                    default:
